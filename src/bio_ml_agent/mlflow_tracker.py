...
class MLTracker:
    ...
    def log_environment_info(self) -> None:
        """Sistem, donanım, python sürümü ve git durumunu loglar."""
        # Sistem
        ...
        try:
            ...
            self.set_tag("git_commit", "unknown")
        ...
        try:
            ...
            self.log_artifact(reqs_path)
        except Exception as e:
            log.warning("requirements.txt loglanamadı: %s", e)

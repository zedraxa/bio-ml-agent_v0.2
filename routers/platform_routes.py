...
from models.remote_gateway import AuthSession, AuthMethod, RemoteSessionRegistry, StreamEvent, EventStreamType
from models.remote_client import DashboardSummaryTemplate, MobileClientAction
from models.remote_storage import CloudArtifactItem, SharedProjectAccess, ProjectAccessRole
from models.remote_browser import BrowserTakeoverEvent, RiskActionApprovalState
from models.cloud_offload import ExecutionTarget, JobClassification, RuntimePackage
from models.cloud_workspace import WorkspaceSnapshot
...
async def get_my_notifications():
    return _notifications[-10:] # Son 10 bildirim
